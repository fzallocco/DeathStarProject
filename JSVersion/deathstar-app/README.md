...
1. Make sure you are in **deathstar-app** directory inside **JSVersion** and run the below command to create the image.

    ```
    docker build -t deathstar:dev . --no-cache 
    ```
...
2. Run the below command to create the container.
    ...
    ```
    docker run -p 3000:3000 deathstar:dev
    ```
***
...
1. Make sure you are in **deathstar-app** directory inside **JSVersion** and run the below command to install the necessary files.
